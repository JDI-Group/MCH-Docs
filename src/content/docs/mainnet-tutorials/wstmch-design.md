...
wstMCH adopts a modular extension mechanism, representing a core innovation compared to traditional single staking protocols:
...
- wstMCH can be used as collateral in other DeFi protocols.
