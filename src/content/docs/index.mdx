...
- ANGO (@Angojp): Web3.0 solution for converting vacant houses in Japan into guesthouses, addressing the vacant house problem while contributing to regional revitalization. Operating 12 properties nationwide with DIY community members. Recruiting DAO members for Hotel & Lodging services. [linktr.ee/angojp](https://linktr.ee/angojp)
