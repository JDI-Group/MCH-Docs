...
hero:
  ...
  tagline: Moonchain is the value layer for ZK & AI. Our IHO hardware converts real-world data into trusted, high-value insights. $MCH uses AI to power, secure & monetize Data across the Moonchain ecosystem 🌖
  image:
