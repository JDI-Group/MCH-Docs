...
```solidity
struct Evidence {
  struct MCHData.BlockMetadata meta;
...
struct State {
  ...
  mapping(uint256 => struct MCHData.ProposedBlock) proposedBlocks;
  mapping(uint256 => mapping(bytes32 => struct MCHData.ForkChoice)) forkChoices;
